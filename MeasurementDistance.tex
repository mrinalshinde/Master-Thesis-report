...
\begin{figure}
  \centering
  \subfigure[Rendering Picture]{\includegraphics[height=6cm]{Antennas/Vivaldi.png}}
  \centering
  \subfigure[Pattern]{\includegraphics[height=6cm]{Antennas/vivaldi_3D.png}}
...
\begin{figure}[H]
  \centering
  \subfigure[TMP; DUT: $\SI{20}{\decibel}$ SGH]{\includegraphics[width=0.49\textwidth]{Matlab/trpDistVivTMP.eps}}
  \centering
  \subfigure[Main EIRP; DUT: $\SI{20}{\decibel}$ SGH]{\includegraphics[width=0.49\textwidth]{{Matlab/trpDistVivEIRP.eps}}}
  \centering
  \subfigure[TMP; DUT: 10x1 patch array \cite{7481205}]{\includegraphics[width=0.49\textwidth]{Matlab/trpDistPaATMP.eps}}
  \centering
  \subfigure[Main EIRP; DUT: 10x1 patch array \cite{7481205}]{\includegraphics[width=0.49\textwidth]{{Matlab/trpDistPaAEIRP.eps}}}
  \centering
  \subfigure[TMP; 2x2 $\SI{20}{\decibel}$ SGH Array]{\includegraphics[width=0.49\textwidth]{Matlab/trpDistH2TMP.eps}}
  \centering
  \subfigure[Main EIRP; 2x2 $\SI{20}{\decibel}$ SGH Array]{\includegraphics[width=0.49\textwidth]{{Matlab/trpDistH2EIRP.eps}}}
...
\begin{figure}[H]
  \centering
  \subfigure[WR28 OEWG 1]{\includegraphics[width=0.3\textwidth]{OEWG-Imp1.jpg}}
  \centering
  \subfigure[WR28 OEWG 2]{\includegraphics[width=0.3\textwidth]{OEWG.jpg}}
  \centering
  \subfigure[Mounted Patch antenna]{\includegraphics[width=0.3\textwidth]{Patch.jpg}}
\caption{Real implementation of probe antennas}
\label{fig:realprobe}
\end{figure}

The minimum and maximum measurement sphere radius varies because of the probe mounting from around $\SI{10}{\centi\meter}$ to around $\SI{115}{\centi\meter}$. From $\SI{10}{\centi\meter}$ to $\SI{16}{\centi\meter}$, $\SI{1}{\centi\meter}$ radius increment, from $\SI{16}{\centi\meter}$ to $\SI{20}{\centi\meter}$ $\SI{2}{\centi\meter}$ radius increment and then $\SI{5}{\centi\meter}$ radius increment is employed. The measurement is carried out by using the $\SI{20}{\decibel}$ \ac{SGH} LB-28-20 by A-Info (figure \ref{fig:hornpro}), the Vivaldi (figure \ref{fig:vivpro}), the Patch (figure \ref{fig:realprobe} (c)) and the two \ac{OEWG} implementations (figure \ref{fig:realprobe} (a) and (b)) as probe and the $\SI{20}{\decibel}$ \ac{SGH} as \ac{DUT}. There are some issues with the probe implementations shown in figure \ref{fig:realprobe}:

\begin{enumerate}[label=(\alph*)]
\item Because no WR28 \ac{OEWG} antenna was available, a WR28 wave guide adapter and an \ac{SGH} mounting was initially taken. With the metal in front of the aperture, the \ac{FF} pattern differs from a real \ac{OEWG} and the directivity increases by around $\SI{4}{\decibel}$. This was simulated in CST\texttrademark{} and the resulting antenna pattern is plotted in figure \ref{fig:oewgimpone}.
\item With another mounting the aperture is free from additional metal. The problem here is, that the metal plate surrounding the opening of the wave guide reflects the \ac{EM} waves emitted towards it. This leads to standing waves in the \ac{NF}.
\item The patch is an omnidirectional radiator (refer to figure \ref{fig:patchpro}). With the absorbers, the directivity of this antenna is rising because the \ac{TRP} is diminishing by absorbing the backwards orientated radiation. Additionally, the patch antenna is placed on a ground plane, which leads similar to the wave guide adapter from (b), to standing waves and \ac{EM} scattering back to the source.
\end{enumerate}
...
\begin{figure}[H]
  \centering
  \subfigure[TMP over measurement distance]{\includegraphics[width=0.49\textwidth]{Matlab/measSGHTMP.eps}}
  \centering
  \subfigure[Main EIRP over measurement distance]{\includegraphics[width=0.49\textwidth]{{Matlab/measSGHEIRP.eps}}}
