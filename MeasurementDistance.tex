...
\begin{figure}
  \centering
  \subfigure[TMP over measurement distance]{\includegraphics[width=0.49\textwidth]{Matlab/trpDistVivTMP.eps}}
  \centering
  \subfigure[Main EIRP over measurement distance]{\includegraphics[width=0.49\textwidth]{{Matlab/trpDistVivEIRP.eps}}}
