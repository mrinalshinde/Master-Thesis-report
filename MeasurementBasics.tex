...
\end{enumerate}
\item \textbf{\acf{CATR}}: For smaller \acp{ATS} the \ac{CATR} was invented. It's using a parabolic mirror to generate \ac{FF}-condition in a much more compact size.
\item \textbf{\acf{OATS}}: Because \acp{AC} are becoming very large and the absorbers expensive at low frequencies \ac{OATS} are used under around $\SI{100}{\mega\hertz}$.
\end{enumerate}
