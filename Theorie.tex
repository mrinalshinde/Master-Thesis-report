...
\begin{figure}[h]
  \centering
  \subfigure[independent azimuth step size]{\includegraphics[width=0.49\textwidth]{Matlab/GridCoStPolar.eps}}
  \centering
  \subfigure[dependent azimuth step size]{\includegraphics[width=0.49\textwidth]{Matlab/GridCoStSinPolar.eps}}
