...
\begin{figure}[H]
	\begin{center}
	\vspace{-1cm}
		\includegraphics[width=0.9\textwidth]{spherical.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[scale = 0.7]{fields_regions.pdf}
