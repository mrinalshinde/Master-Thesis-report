...
\vspace{-0.2cm}  \caption{Conducted measurements using attenuators and splitters: \acs{DUT} behaves as a transmitter}
 \label{fig:Ng1} 
\end{figure}
...
\centering
 ...
 \vspace{-0.2cm} \caption{Conducted measurements using attenuators and splitters: \acs{DUT} behaves as a receiver}
   \label{fig:Ng2}
\end{figure}
...
For example, the standard mentions that at blocker frequency of 2360 MHz, the required blocker level in front of the \acs{DUT} is -53 dBm. Assume the total attenuation is 40 dB and the antenna gain of the \acs{DUT} is 3 dBi. Then,
